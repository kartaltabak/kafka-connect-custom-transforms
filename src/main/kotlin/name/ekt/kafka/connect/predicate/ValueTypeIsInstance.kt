...
/**
 * A predicate that checks if the record value is an instance of a specific type.
 * Uses Class.forName() to load the target type and isInstance() to check the type.
 */
class ValueTypeIsInstance<R : ConnectRecord<R>> : Predicate<R> {
    private companion object {
        ...
        val CONFIG_DEF: ConfigDef = ConfigDef()
            .define(
                ...
                "The fully qualified class name to check for (e.g., java.lang.String, " +
                        "org.apache.kafka.connect.data.Struct)"
            )
    }

    private val logger = LoggerFactory.getLogger(ValueTypeIsInstance::class.java)
    ...
    override fun configure(configs: Map<String, *>?) {
        ...
        try {
            ...
            logger.info("Configured ValueTypeIsInstance predicate with type: {}", typeName)
